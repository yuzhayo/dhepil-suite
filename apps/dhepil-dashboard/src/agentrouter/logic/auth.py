"""
src/agentrouter/logic/auth.py
==============================
Semua hal terkait Playwright untuk AgentRouter: login manual sekali, lalu
refresh sesi otomatis berkala.

Provider-specific: alur login (tombol GitHub, redirect ke console) hanya
berlaku untuk AgentRouter, jadi tidak boleh naik ke shared/.

Disalin dari apps/agentrouter_dashboard/lib/auth.py dengan satu perubahan
perilaku: kegagalan sekarang di-raise sebagai AuthError dengan kode gate,
bukan dikembalikan sebagai False. Return False memaksa setiap caller ingat
memeriksa nilai baliknya - kalau lupa, kegagalan lewat tanpa jejak, dan itu
persis kelas bug yang paling berbahaya di sini.
"""
