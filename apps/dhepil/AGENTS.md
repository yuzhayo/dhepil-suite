# Dhepil App Ownership

Aturan parent `apps/AGENTS.md` berlaku penuh.

Folder ini dimiliki app `dhepil`. Port ditetapkan dan dikunci oleh root control center.

- Jangan mengubah root control center atau `apps/spreadsheet-minimal` dari pekerjaan app ini.
...
- Version dan `CHANGELOG.md` dimiliki automation root. Jangan bump, edit, atau membuat release task manual; gunakan `npm run release:app -- dhepil` dari root.
